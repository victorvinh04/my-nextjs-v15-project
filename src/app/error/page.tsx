...
const ErrorPage = () => {
  return (
    <section className="relative z-10 pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px]">
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4">
            <div className="mx-auto text-center mb-9">
              ...
              <h3 className="mb-4 text-3xl font-bold text-black dark:text-white sm:text-4xl">Sorry, the page can’t be found</h3>
              <p className="mb-10 text-base font-medium text-body-color sm:text-lg sm:leading-relaxed">
                The page you were looking for appears to have been moved,
                deleted or does not exist.
              </p>
              <Link
                href="/"
                className="px-8 py-3 mb-10 text-base font-bold text-white duration-300 rounded-md bg-primary sm:text-lg sm:leading-relaxed shadow-sign-up hover:bg-white hover:text-primary md:px-9 lg:px-8 xl:px-9"
              >
                Back to Homepage
              </Link>
            </div>
      ...
      <div className="absolute z-[-1] hidden sm:block lg:block xl:block left-0 bottom-0">
        <svg
          width="406"
          height="286"
          viewBox="0 0 406 286"
      ...
      <div className="absolute z-[-1] hidden sm:block lg:block xl:block right-0 top-0">
        <svg
          width="406"
          height="286"
          viewBox="0 0 406 286"
