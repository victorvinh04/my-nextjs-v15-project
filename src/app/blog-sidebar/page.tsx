        ...
        <div className="container">
          <div className="flex flex-wrap -mx-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center justify-between pb-4 mb-10 border-b border-body-color border-opacity-10 dark:border-white dark:border-opacity-10">
                  ...
                  <div className="mb-5">
                    <a
                      href="#0"
                      className="inline-flex items-center justify-center px-4 py-2 text-sm font-semibold text-white rounded-full bg-primary dark:text-dark"
                    >
                      Design
                    </a>
                  </div>
                ...
                <div>
                  ...
                  <div className="relative z-10 p-8 mb-10 overflow-hidden rounded-md bg-primary/10 bg-opacity-10 md:p-9 lg:p-8 xl:p-9">
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className="p-6 mt-12 mb-10 bg-white rounded-sm shadow-three dark:bg-gray-dark dark:shadow-none lg:mt-0">
                <form className="flex items-center justify-between">
                  ...
                  />
                  <button className="flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-sm bg-primary text-white">
                    <svg
                      width="20"
                      height="18"
                      viewBox="0 0 20 18"
              ...
              <div className="mb-10 rounded-md bg-primary/10 bg-opacity-5 dark:bg-opacity-10">
