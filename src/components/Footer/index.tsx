...
const Footer = () => {
  return (
    <>
      <footer
        className="relative z-10 pt-16 bg-gray-light dark:bg-gray-dark md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="oklch(0.59 0.21 268.61)" stopOpacity="0.62" />
                <stop
                  offset="1"
                  stopColor="oklch(0.59 0.21 268.61)"
                  stopOpacity="0"
                />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="oklch(0.59 0.21 268.61)" stopOpacity="0" />
                <stop
                  offset="1"
                  stopColor="oklch(0.59 0.21 268.61)"
                  stopOpacity="0.51"
