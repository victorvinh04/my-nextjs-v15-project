const NewsLatterBox = () => {
  return (
    <div className="relative z-10 p-8 bg-white rounded-sm shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11" data-wow-delay=".2s">
      ...
      <form>
        <input
          ...
          className="border-stroke mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303A] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="w-full px-6 py-3 mb-4 text-base font-medium text-center text-white transition ease-in-out border border-transparent rounded-md cursor-pointer duration-80 bg-primary outline-hidden hover:bg-opacity-80 hover:shadow-signUp focus-visible:shadow-none"
        />
        <p className="text-base font-medium leading-relaxed text-center text-body-color">
