    ...
    <>
      <header
        className={`header top-0 left-0 z-40 flex w-full items-center bg-transparent ${
          sticky
            ? "fixed! z-9999! bg-opacity-80! shadow-sticky backdrop-blur-xs transition! bg-white dark:bg-gray-dark dark:bg-opacity-20! dark:shadow-sticky-dark"
            : "absolute"
        }`}
      >
          ...
          <div className="relative flex items-center justify-between -mx-4">
            ...
            <div className="flex items-center justify-between w-full px-4">
                        ...
                        {menuItem.path ? (
                          ...
                          <>
                            <a
                              ...
                              className="flex items-center justify-between py-2 text-base cursor-pointer text-dark group-hover:opacity-70 dark:text-white lg:mr-0 lg:inline-flex lg:py-6 lg:px-0"
                            >
                              {menuItem.title}
                              <span className="pl-3">
                            ...
                            >
                              {menuItem.submenu?.map((submenuItem) => (
                                <Link
                                  ...
                                  key={submenuItem.id}
                                  className="block rounded-sm py-2.5 text-sm text-dark hover:opacity-70 dark:text-white lg:px-3"
                                >
                                  {submenuItem.title}
                                </Link>
                              ))}
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                ...
                <Link
                  href="/signup"
                  className="hidden px-8 py-3 text-base font-bold transition duration-300 rounded-md bg-primary bg-prima ease-in-up hover:bg-opacity-90 hover:shadow-signUp md:block md:px-9 lg:px-6 xl:px-9 dark:text-white"
                >
                  Sign Up
                </Link>
                <div className="px-2 py-5 lg:pl-6">
                  <ThemeToggle />
                </div>
              </div>
            </div>
